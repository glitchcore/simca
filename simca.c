...
void    ReadATR()
{
    ...
    fprintf(outfile,"historical count: %d\n", historical_ch_count);
    ...
    fprintf (outfile," %02X",atr.TD2);
    fprintf (outfile," %02X",atr.TA3);
    ...
    fprintf(outfile,"\tGlobal interface character TD2=%02X\n",atr.TD2);
    fprintf(outfile,"\tGlobal interface character TA3=%02X\n",atr.TA3);
...
char    *get_cmd_name(int ins)
{
    ...
    case    0x22    :   return "MANAGE SECURITY ENV";
...
void CheckSimEcho(t_byte ins)
{
    t_byte sim_ins_rply = i_getchar();
    if (sim_ins_rply == ins) {
...
void ReadCommand()
{
    ...
    case 0x22:
        fprintf(outfile,"ME:");
        read_block(params,p3,0);
        fprintf(outfile," - (Off-Card Entity data)\n");
        fprintf(outfile,"SIM:");
